...
[![Maven Central](https://img.shields.io/badge/maven--central-v0.0.3-SNAPSHOT-blue.svg)](https://oss.sonatype.org/content/repositories/snapshots/net/cakesolutions/docker-compose-testkit_2.11/0.0.3-SNAPSHOT/docker-compose-testkit_2.11-0.0.3-SNAPSHOT.pom)
...
file:
```
libraryDependencies += "net.cakesolutions" %% "docker-compose-testkit" % "0.0.3-SNAPSHOT"
```
