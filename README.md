...
| Release              | [![Maven Central](https://img.shields.io/badge/maven--central-v0.0.5-SNAPSHOT-blue.svg)](https://oss.sonatype.org/service/local/repositories/releases/content/net/cakesolutions/docker-compose-testkit_2.11/0.0.5-SNAPSHOT/docker-compose-testkit_2.11-0.0.4.pom) |
...
file:
```
libraryDependencies += "net.cakesolutions" %% "docker-compose-testkit" % "0.0.5-SNAPSHOT"
```
